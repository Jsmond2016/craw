...
![](http://poetries1.gitee.io/img-repo/2020/07/84.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/85.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/86.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/88.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/90.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/91.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/92.gif)
...
![](http://poetries1.gitee.io/img-repo/2020/07/93.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/94.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/95.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/96.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/97.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/98.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/99.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/100.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/101.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/102.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/103.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/104.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/105.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/106.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/107.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/108.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/109.png)
...
提取了公共代码部分，易于维护， 因为公共的方法被提取到了父类，那么如果我们需要修改算法中不变的步骤时，不需要到每- 一个子类中去修改，只要改一下对应父类即可；
...
![](http://poetries1.gitee.io/img-repo/2020/07/112.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/113.png) ![](http://poetries1.gitee.io/img-repo/2020/07/114.png)
...
*  `MVVM` 模式： 引入双向绑定机制，帮助实现一些更新视图层和模型层的工作，让开发者可以更专注于业务逻辑，相比于之前的模式，可以使用更少的代码量完成更复杂的交互；
...
![](http://poetries1.gitee.io/img-repo/2020/07/115.png)

>在实际操作时，用户可以直接对 `View` 层的 `UI` 进行操作，以通过事件通知 `Controller` 层，经过处理后修改 `Model` 层的数据，`Model` 层使用最新数据更新 `View`。示意图如下：

![](http://poetries1.gitee.io/img-repo/2020/07/116.png)

用户也可以直接触发 `Controller` 去更新 `Model` 层状态，再更新 View 层：

![](http://poetries1.gitee.io/img-repo/2020/07/117.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/120.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/121.png)

>这是为什么呢，因为 `MVVM` 模式要求 `Model` 层和 `View` 层完全解耦，但是由于 `Vue` 还提供了 `ref` 这样的 `API`，使得 `Model` 也可以直接持有 `View`：

![](http://poetries1.gitee.io/img-repo/2020/07/122.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/125.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/126.png)
...
![](http://poetries1.gitee.io/img-repo/2020/07/127.png)
